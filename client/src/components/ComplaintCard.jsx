...
import { 
  ...
  Info, ExternalLink, GitBranch, ArrowUpCircle, Shield
} from 'lucide-react';
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ display: 'flex', gap: '32px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>{c.user?.email.split('@')[0]}</div>
            </div>
          </div>
        </div>
      ...
      <div className="glass-panel" style={{ 
        ...
        <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '1fr 340px', overflow: 'hidden' }}>
                    ...
                    <div key={comment.id} style={{ display: 'flex', gap: '16px' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
                          <span style={{ fontWeight: 700, fontSize: '0.85rem' }}>{comment.user.email.split('@')[0]}</span>
          ...
          <div style={{ borderLeft: '1px solid var(--border-color)', background: 'var(--bg-tertiary)', padding: '32px', overflowY: 'auto' }}>
            ...
            <div style={{ marginBottom: '32px' }}>
              <h5 style={{ fontSize: '0.7rem', fontWeight: 800, color: 'var(--text-muted)', textTransform: 'uppercase', marginBottom: '20px' }}>Complaint Info</h5>
            ...
            <div style={{ marginBottom: '32px' }}>
              ...
              {c.assignedTo ? (
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', background: 'var(--bg-secondary)', padding: '12px', borderRadius: '12px', border: '1px solid var(--border-color)' }}>
                  ...
                  <div>
                    <div style={{ fontSize: '0.9rem', fontWeight: 700 }}>{c.assignedTo.email.split('@')[0]}</div>
              ...
              <div className="glass-panel" style={{ padding: '20px', background: 'rgba(0,97,255,0.05)', border: '1px solid var(--accent-blue)' }}>
                ...
                {!c.assignedToId ? (
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                    {c.status !== 'RESOLVED' && (
                      <button className="btn btn-primary" style={{ width: '100%', background: 'var(--success)' }} onClick={() => handleStatusUpdate('RESOLVED')}>Mark Resolved</button>
                    )}
